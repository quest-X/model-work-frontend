...
export class AIModelsSelector {
    ...
    public static getModelsByType(state: AppState, modelType: AIModel['modelType']): AIModel[] {
        return state.aimodels.models.filter(model => model.modelType === modelType);
    }

    public static getActiveModelByType(state: AppState, modelType: AIModel['modelType']): AIModel | null {
    ...
    public static hasModelsOfType(state: AppState, modelType: AIModel['modelType']): boolean {
