...
export class AIModelsSelector {
    ...
    public static getActiveModelByType(state: AppState, modelType: 'detection' | 'segmentation' | 'retrieval'): AIModel | null {
    ...
    public static hasModelsOfType(state: AppState, modelType: 'detection' | 'segmentation' | 'retrieval'): boolean {
