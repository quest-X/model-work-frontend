...
export class AIModelsSelector {
    ...
    public static getModelsByType(state: AppState, modelType: 'detection'): AIModel[] {
        return state.aimodels.models.filter(model => model.modelType === modelType);
    }

    public static getActiveModelByType(state: AppState, modelType: 'detection'): AIModel | null {
    ...
    public static hasModelsOfType(state: AppState, modelType: 'detection'): boolean {
