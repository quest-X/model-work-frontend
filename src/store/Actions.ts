export enum Action {
    ...
    UPDATE_SEGMENTATION_API_CONFIG = '@@UPDATE_SEGMENTATION_API_CONFIG',
    UPDATE_FULL_IMAGE_INFERENCE_STATUS = '@@UPDATE_FULL_IMAGE_INFERENCE_STATUS',
    UPDATE_RETRIEVAL_MODE_STATUS = '@@UPDATE_RETRIEVAL_MODE_STATUS',
    UPDATE_RETRIEVAL_SEGMENTATION_STATUS = '@@UPDATE_RETRIEVAL_SEGMENTATION_STATUS',
