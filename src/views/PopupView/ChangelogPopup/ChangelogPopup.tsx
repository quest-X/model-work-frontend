...
const CHANGELOG_DATA: ChangelogEntry[] = [
    {
        ...
        date: '2026-09-07',
        changes: [
            { zh: '【训练】支持取消训练任务、查看日志与加载输出', en: '[Training] Added training cancellation, logs, and output loading' },
            { zh: '【安全】支持注册身份、签名设备连接与签名升级', en: '[Security] Added registered identities, signed device connections, and signed upgrades' },
            { zh: '【运维】统一账号会话、节点状态、升级日志与故障显示', en: '[Operations] Unified account sessions, node status, upgrade logs, and fault display' },
            { zh: '【体验】统一 OpenSight 品牌、分组资源、扫描进度与终端补全', en: '[UX] Unified OpenSight branding, grouped resources, scan progress, and terminal completion' },
        ],
    },
    {
        version: '2.8.9',
        date: '2026-09-05',
        changes: [
            { zh: '【功能】新增资源、任务与会话一体化 OpenSight 控制中心', en: '[Feat] Added a unified OpenSight control center for resources, tasks, and conversations' },
            { zh: '【监控】支持进程搜索以及 CPU、GPU、内存与温度监控', en: '[Monitoring] Added process search plus CPU, GPU, memory, and temperature monitoring' },
            { zh: '【运维】整合节点 Agent、设备、远程相机与二元健康状态', en: '[Operations] Integrated node agents, devices, remote cameras, and binary health status' },
            { zh: '【可靠性】完善模型生命周期、OCR/视频推理与密集拓扑展示', en: '[Reliability] Improved model lifecycle, OCR/video inference, and dense-topology rendering' },
        ],
    },
    {
        version: '2.8.8',
