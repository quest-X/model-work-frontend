...
const PipelineInferencePopup: React.FC<IProps> = ({language, activeModelType}) => {
    ...
    const renderConfidence = () => <div className={`ParamRow${!confEnabled ? ' param-disabled' : ''}`}>
    ...
    const renderIou = () => <div className={`ParamRow${!iouEnabled ? ' param-disabled' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderMaxDetections = () => <div className={`ParamRow${!maxDetEnabled ? ' param-disabled' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderAgnosticNms = () => <div className={`ParamRow${!agnosticNms ? ' param-disabled' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderClassFilter = () => <div className={`ParamRow${!classesEnabled ? ' param-disabled' : classes.trim() === '' ? ' param-zero' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderRetinaMasks = () => <div className={`ParamRow${!retinaMasks ? ' param-disabled' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
