...
const isPositiveParameterEnabled = (sectionActive: boolean, enabled: boolean, value: number): boolean =>
    sectionActive && enabled !== false && value > 0;
...
const PipelinePostprocessPopup: React.FC<IProps> = ({language, activeModelType, selectedModelTask}) => {
    ...
    const [minBboxAreaEnabled, setMinBboxAreaEnabled] = useState<boolean>(isPositiveParameterEnabled(detSectionActive, initialDet.min_bbox_area_enabled, initialDet.min_bbox_area));
    const [bboxPaddingEnabled, setBboxPaddingEnabled] = useState<boolean>(isPositiveParameterEnabled(detSectionActive, initialDet.bbox_padding_enabled, initialDet.bbox_padding));
    ...
    const [epsilonEnabled, setEpsilonEnabled] = useState<boolean>(isPositiveParameterEnabled(segSectionActive, initialSeg.polygon_epsilon_enabled, initialSeg.polygon_epsilon));
    const [minAreaEnabled, setMinAreaEnabled] = useState<boolean>(isPositiveParameterEnabled(segSectionActive, initialSeg.min_mask_area_enabled, initialSeg.min_mask_area));
    const [maskDilateEnabled, setMaskDilateEnabled] = useState<boolean>(isPositiveParameterEnabled(segSectionActive, initialSeg.mask_dilate_enabled, initialSeg.mask_dilate));
    const [maxPolygonPointsEnabled, setMaxPolygonPointsEnabled] = useState<boolean>(isPositiveParameterEnabled(segSectionActive, initialSeg.max_polygon_points_enabled, initialSeg.max_polygon_points));
    ...
    const detHasAnyEnabled = [minBboxAreaEnabled, bboxPaddingEnabled].some(Boolean);
    const segHasAnyEnabled = [epsilonEnabled, minAreaEnabled, maskDilateEnabled, maxPolygonPointsEnabled, maskIouThresholdEnabled, largestOnly].some(Boolean);
    ...
    const renderMinBboxArea = () => <div className={`ParamRow${!minBboxAreaEnabled ? ' param-disabled' : minBboxArea === 0 ? ' param-zero' : ''}`}>
    ...
    const renderBboxPadding = () => <div className={`ParamRow${!bboxPaddingEnabled ? ' param-disabled' : bboxPadding === 0 ? ' param-zero' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderMinMaskArea = () => <div className={`ParamRow${!minAreaEnabled ? ' param-disabled' : minArea === 0 ? ' param-zero' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderPolygonEpsilon = () => <div className={`ParamRow${!epsilonEnabled ? ' param-disabled' : epsilon === 0 ? ' param-zero' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderMaxPolygonPoints = () => <div className={`ParamRow${!maxPolygonPointsEnabled ? ' param-disabled' : maxPolygonPoints === 0 ? ' param-zero' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderMaskDilation = () => <div className={`ParamRow${!maskDilateEnabled ? ' param-disabled' : maskDilate === 0 ? ' param-zero' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderMaskIou = () => <div className={`ParamRow${!maskIouThresholdEnabled ? ' param-disabled' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderLargestMask = () => <div className={`ParamRow${!largestOnly ? ' param-disabled' : ''}`}>
        <div className='ParamHeader'>
            <label className='ParamLabelRow'>
    ...
    const renderDetectionSection = () => showDet && <div className={`ParamSection${!detSectionActive ? ' section-inactive' : !detHasAnyEnabled ? ' section-dimmed' : ''}`}>
    ...
    const renderSegmentationSection = () => showSeg && <div className={`ParamSection${!segSectionActive ? ' section-inactive' : !segHasAnyEnabled ? ' section-dimmed' : ''}`}>
        ...
        {/* polygon_epsilon */}
        {renderPolygonEpsilon()}

        {/* max_polygon_points */}
        {renderMaxPolygonPoints()}
